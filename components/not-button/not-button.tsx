...
import type { ButtonTypes } from '../button/button';

type NotButtonPropsType = {
...
const NotButton = forwardRef<HTMLAnchorElement, NotButtonPropsType>(
  (props, ref) => {
    const {
...
export { NotButton };
export type { NotButtonPropsType };
